...
# datasets
flags.DEFINE_integer('obj_c', 2, 'nnumber of categories')
flags.DEFINE_string('dataset', 'IsaacSIM', 'IsaacSIM or Real or CAMERA or CAMERA+Real')
flags.DEFINE_string('dataset_dir', '[Download DIR]/data', 'path to the dataset')
flags.DEFINE_string('detection_dir', '[Detection_DIR]/model/results', 'path to detection results')
...
# pose network
# origin : 1286
flags.DEFINE_integer('feat_c_R', 1282, 'input channel of rotation')
flags.DEFINE_integer('R_c', 4, 'output channel of rotation, here confidence(1)+ rot(3)')
flags.DEFINE_integer('feat_c_ts', 1285, 'input channel of translation and size')
...
flags.DEFINE_string('resume_model', '/home/songoh/hojun_ws/GPV_Pose/engine/output/modelsave_all/model_139.pth', 'path to the saved model')
flags.DEFINE_integer('resume_point', 139, 'the epoch to continue the training')

#Fine-Tuning
#Geometric Feature Extraction Freeze !!
flags.DEFINE_string('training_stage_freeze', 'face_recon', 'freeze parameters : face_recon pose_net ...')
