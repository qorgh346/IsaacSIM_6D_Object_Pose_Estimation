...
from network.ISOPENetwork import ISOPENetwork
...
torch.autograd.set_detect_anomaly(True) #hwan
device = 'cuda'
...
def train(argv):
    ...
    #  build optimizer
    param_list = network.build_params(FLAGS.training_stage_freeze)
