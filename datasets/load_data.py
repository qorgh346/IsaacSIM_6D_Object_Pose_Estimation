...
class PoseDataset(data.Dataset):
    def __init__(self, source=None, mode='train', data_dir=None,
        ...
        assert source in ['CAMERA', 'Real', 'CAMERA+Real', 'IsaacSIM']
        ...
        #
        img_list_path = [f'{source}/train_list_all.txt',f'{source}/test_list_all.txt']
        model_file_path = [f'{source}obj_models/real_train.pkl',f'{source}/obj_models/real_test.pkl']
        ...
        if source in ['CAMERA', 'Real', 'CAMERA+Real']:
        ...
        # obj 파일 읽기
        obj_dir = os.path.join(self.data_dir, f'obj_models/{source}_{mode}')
